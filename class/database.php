...
// DB::exe('INSERT INTO `tmp_cms_user` (`userID`, `username`, `password`, `usermail`, `userregtime`,`userIP`,`hash`) values (:userID,:username,:password,:usermail,:userregtime,:userIP,:hash);',
